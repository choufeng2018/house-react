        ...
        return (
            <Spin spinning = {this.state.spin}>
                <div style={{borderBottom: 'solid 1px #999', padding: '0 0 5px 0', marginBottom: 5}}>
                    {this.state.type === 'dormitory' ? <Button style = {{marginLeft: '20px'}} onClick={this.distriDormitory.bind(this)}>业主登记</Button> : <Button style = {{"display": 'none', marginLeft: '20px'}}></Button>}
                </div>
                <Tree
